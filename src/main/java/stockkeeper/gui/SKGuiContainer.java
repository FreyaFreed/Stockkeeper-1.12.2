...
public abstract class SKGuiContainer extends GuiScreen
{
    ...
    public SKGuiContainer(Container inventorySlotsIn)
    {
    ...
    private void drawSlot(Slot slotIn)
    {
        ...
        if (!flag1)
        {
            ...
            if(slotIn.getHasStack())
            	stacksize = slotIn.getStack().getCount();
            
            if(stacksize > 999 && stacksize < 10000)
            {
            	float out = stacksize / 1000.1f; 
            	String formattedString = String.format("%.01f", out);
            	
            	this.itemRender.renderItemOverlayIntoGUI(this.fontRenderer, itemstack, i, j, formattedString + "k");
            }
            else if(stacksize >= 10000)
            {
            	this.itemRender.renderItemOverlayIntoGUI(this.fontRenderer, itemstack, i, j, stacksize/1000 + "k");
            }
            else
            {
